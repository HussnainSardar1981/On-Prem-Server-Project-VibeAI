    ...
    def validate_device_capabilities(self, device_id: int, is_input: bool) -> bool:
        ...
        try:
            ...
            is_supported = self.pyaudio.is_format_supported(
                ...
                input_device=device_id if is_input else None,
                output_device=device_id if not is_input else None,
                input_channels=self.config.channels if is_input else None,
                output_channels=self.config.channels if not is_input else None,
...
class VoiceBot:
    ...
    def initialize_pjsua2(self) -> bool:
        ...
        try:
            ...
            self.endpoint.libInit(pj.UAConfig(), pj.LogConfig(), pj.MediaConfig())
